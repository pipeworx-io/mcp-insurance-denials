...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/insurer_denial_rates \
  -H 'Content-Type: application/json' \
  -d '{"market":"medical","limit":5}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/insurer_denial_rates`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
